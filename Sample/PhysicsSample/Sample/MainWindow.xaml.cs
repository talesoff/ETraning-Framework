...
namespace PhysicsSample
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            this.Sample1_Button.Click += Sample1Button_Click;
            this.Sample2_Button.Click += Sample2Button_Click;
        ...
        void Sample1Button_Click(object sender, RoutedEventArgs e)
        {
            if(SimulationApplication.Instance.getisRun() == false)
                SimulationApplication.Instance.Start(1);
        }

        void Sample2Button_Click(object sender, RoutedEventArgs e)
        {
            if (SimulationApplication.Instance.getisRun() == false)
                SimulationApplication.Instance.Start(2);
        }
    }
}
